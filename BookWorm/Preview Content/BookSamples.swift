...
extension Book {
  ...
  static var sampleBooks: [Book] {
    [
      Book(title: "QBVII", author: "Leon Uris", genre: "Thriller", review: "", rating: 4),
      Book(title: "Macbeth",
           author: "William Shakespear",
           genre: "Mystery",
           review: "what a tangled web we weave!",
           rating: 5),
      Book(title: "Silence of the Grave",
           author: "Arnuldur Indrason, Bernard Scudder",
           genre: "Thriller",
           review: "Inheriting Ian Fleming's long-lost account of his spy activities during World War II, young American academic Amy Greenberg finds herself targeted by unknown assailants and must race to finish the manuscript in order to save her life and reveal the actions of a traitor.",
           rating: 4),
//      Book(title: "Cardinal",
//           author: "Giles Blunt"),
      Book(title: "Jackdaws",
